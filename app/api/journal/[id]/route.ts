...
export async function PUT(
  ...
  try {
    ...
    const updateData: any = {
      ...
      measurement_end_date: bodyClean.measurement_end_date ?? existingJournal.measurement_end_date,
      ...
      measurer: bodyClean.measurer ?? existingJournal.measurer,
      completion_status: bodyClean.completion_status ?? existingJournal.completion_status,

      // K2B/계산서 정보
      k2b_send_date: bodyClean.k2b_send_date ?? existingJournal.k2b_send_date,
      k2b_sender: bodyClean.k2b_sender ?? existingJournal.k2b_sender,
      invoice_email: bodyClean.invoice_email ?? existingJournal.invoice_email,
      invoice_email_2: bodyClean.invoice_email_2 ?? existingJournal.invoice_email_2,
      electronic_invoice_date: bodyClean.electronic_invoice_date ?? existingJournal.electronic_invoice_date,
      electronic_invoice_date_2: bodyClean.electronic_invoice_date_2 ?? existingJournal.electronic_invoice_date_2,
      invoice_business_name: truncateField(bodyClean.invoice_business_name ?? existingJournal.invoice_business_name, 255, 'invoice_business_name'),
      invoice_business_number: cleanToDigits(bodyClean.invoice_business_number ?? existingJournal.invoice_business_number),

      // 측정비 정보
      measurement_fee_total: bodyClean.measurement_fee_total ?? existingJournal.measurement_fee_total,
      measurement_fee_business: bodyClean.measurement_fee_business ?? existingJournal.measurement_fee_business,
      measurement_fee_national: bodyClean.measurement_fee_national ?? existingJournal.measurement_fee_national,

      // 입금 정보
      deposit_date_business: bodyClean.deposit_date_business ?? existingJournal.deposit_date_business,
      deposit_amount_business: bodyClean.deposit_amount_business ?? existingJournal.deposit_amount_business,
      deposit_date_business_2: bodyClean.deposit_date_business_2 ?? existingJournal.deposit_date_business_2,
      deposit_amount_business_2: bodyClean.deposit_amount_business_2 ?? existingJournal.deposit_amount_business_2,
      deposit_date_national: bodyClean.deposit_date_national ?? existingJournal.deposit_date_national,
      deposit_amount_national: bodyClean.deposit_amount_national ?? existingJournal.deposit_amount_national,
      deposit_total: bodyClean.deposit_total ?? existingJournal.deposit_total,
