...
# Types
rep("lib/preliminary-survey-v2/reverse-planner/types.ts",
...
# Snapshot
rep("lib/preliminary-survey-v2/reverse-planner/snapshot.ts",
...
# Route
rep("app/api/preliminary-survey-v2/reverse-planner/route.ts",
...
# Solver
rep("lib/preliminary-survey-v2/reverse-planner/solver.ts",
...
# UI
rep("components/features/FixedAssigneeReversePlanner.tsx",
...
# Tests
rep("tests/preliminary-survey-reverse-planner.test.ts",
    'import { buildPlanningSnapshot } from "../lib/preliminary-survey-v2/reverse-planner/snapshot";\n',
    'import { buildPlanningSnapshot } from "../lib/preliminary-survey-v2/reverse-planner/snapshot";\nimport { adminOverrideSourceChanged, isAdminExplicitOverridePlan } from "../lib/preliminary-survey-v2/reverse-planner/admin-override-protection";\n')
p = Path("tests/preliminary-survey-reverse-planner.test.ts")
text = p.read_text()
if "관리자 명시 편성은 일반 hard rule 위반이어도 재계산에서 그대로 유지한다" in text:
