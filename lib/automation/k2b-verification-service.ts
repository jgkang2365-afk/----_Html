...
export async function querySubmissionResultsForDate(
  ...
  return withK2BReadOnlySession(k2b => k2b.querySubmissionResultsForDate(resultDate));
}
...
export async function querySubmissionResultsForRange(
  ...
  return withK2BReadOnlySession(k2b => k2b.querySubmissionResultsForRange(fromDate, toDate));
}
