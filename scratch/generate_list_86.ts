...
async function exportList86() {
  ...
  let mdContent = "# 업종 코드 '86' 사업장 전체 리스트\n\n";
  ...
  fs.writeFileSync(path.join(process.cwd(), "scratch", "list_86.md"), mdContent, "utf8");
  console.log("File scratch/list_86.md generated successfully.");
}
