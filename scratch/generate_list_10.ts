...
async function exportList10() {
  ...
  let mdContent = "# 업종 코드 '10' 사업장 전체 리스트\n\n";
  ...
  fs.writeFileSync(path.join(process.cwd(), "scratch", "list_10.md"), mdContent, "utf8");
  console.log("File scratch/list_10.md generated successfully.");
}
